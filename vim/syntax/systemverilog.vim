...
syntax match svPreProc "`uvm_[a-z_]\+\>"
syntax match svType "uvm_[a-z_]\+\>"
syntax match svPreCondit "`\(else\|elsif\|endif\|ifdef\|ifndef\|define\)\>"
syntax match svInclude "`include\>"
syntax match svDefine "__[A-Z_]\+_SV__\>"
